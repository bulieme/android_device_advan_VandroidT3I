...
TARGET_BOARD_PLATFORM := mt6577               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := Vandroid     # From ro.product.board
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 600000
...
TW_THEME := potrait_hdpi                     # Set the exact theme you wanna use. If resulation doesn't match, define the height/width
